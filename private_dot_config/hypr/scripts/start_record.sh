...
# Start recording using ffmpeg
 ...
 wf-recorder -f "$HOME/Videos/screenrecordings/$(date '+%Y-%m-%d_%H-%M-%S').mp4" -r 30 --audio=bluez_output.62_A2_CF_10_65_E2.1.monitor --codec libx264 --crf 28 &
notify-send -i camera-video "wf-recorder" "Recording started"
